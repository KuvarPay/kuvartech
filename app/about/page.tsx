    ...
    <>
      <header className="page-hero" data-screen-label="About — Hero">
        <div className="wrap">
          ...
          <h1 className="h-display reveal-words" data-reveal-words style={{ marginTop: "18px", maxWidth: "16ch" }}>
      ...
      <section className="section" data-screen-label="About — Impact">
        <div className="wrap">
          <div style={{ maxWidth: "620px", marginBottom: "44px" }}>
            ...
            <p className="muted" data-reveal style={{ "--reveal-delay": "120ms", marginTop: "14px", fontSize: "14px" }}>
      ...
      {/* CTA */}
      <section className="section-tight" style={{ paddingBottom: "96px" }} data-screen-label="About — CTA">
        <div className="wrap" style={{ textAlign: "center", maxWidth: "760px", margin: "0 auto" }}>
          <h2 className="h-section reveal-words" data-reveal-words>Want to help build it?</h2>
          <div style={{ display: "flex", gap: "14px", justifyContent: "center", marginTop: "28px", flexWrap: "wrap" }} data-reveal>
            ...
            <Link className="btn btn-ghost btn-lg" href="/solutions">Explore solutions</Link>
          </div>
        </div>
      </section>
    </>
